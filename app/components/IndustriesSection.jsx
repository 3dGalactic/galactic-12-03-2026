...
export const INDUSTRIES_DATA = [
  {
    ...
    category: "Aerospace",
    icon: Plane,
    image: "/images/aerospace-jet.jpg",
  ...
  },
  {
    ...
    category: "Medical",
    icon: Activity,
    image: "/images/medical-healthcare.png",
  ...
  },
  {
    ...
    icon: Cpu,
    image: "/images/electronics-semiconductor.jpg",
...
function IndustriesSectionInner() {
  ...
  return (
    <section className="py-16 lg:py-20 bg-transparent border-t border-[#EAEAEA] font-sans relative overflow-hidden">
